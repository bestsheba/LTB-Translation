@php
    ...
    $audiences = $isArabic
        ...
        : [
            ...
            [
                'label' => 'Individuals needing certified translation for official purposes',
    ...
    <div class="max-w-5xl mx-auto px-6 grid gap-6 md:grid-cols-2">
        @foreach ($audiences as $audience)
            <div class="p-6 rounded-2xl border border-gray-200 shadow-sm flex gap-4 items-center bg-white">
                <span
                    class="h-12 w-12 rounded-2xl bg-[#D60F12]/10 text-[#D60F12] flex items-center justify-center text-2xl flex-shrink-0">

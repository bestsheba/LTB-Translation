@php
    ...
    $advantages = $isArabic
        ? [
            [
                'title' => 'فريق ترجمة ذو خبرة عالية:',
                'desc' => ' شبكة عالمية تضم أكثر من 150 مترجمًا معتمدًا وذوي كفاءة عالية.',
                'icon' => 'fa-solid fa-people-group',
            ],
            [
                'title' => 'اعتراف رسمي:',
                'desc' => 'ترجمات مقبولة لدى الجهات الحكومية والوزارات والسفارات داخل المملكة وخارجها.',
            ...
            [
                'title' => 'دقة عالية:',
                'desc' => 'تدقيق داخلي ومراقبة جودة لكل مستند لضمان أعلى مستوى من الدقة.',
                'icon' => 'fa-solid fa-bullseye',
            ],
            [
                'title' => 'سرعة في التسليم:',
                'desc' => 'تسليم المستندات الصغيرة خلال ساعة واحدة، والمشاريع الكبيرة خلال 24 ساعة.',
            ...
            [
                ...
                'desc' => 'إمكانية إرسال واستلام المستندات بسهولة عبر الواتساب أو البريد الإلكتروني.',
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-12">
            ...
            <p class="text-xl md:text-2xl text-[#D60F12] mb-3">
                {{ $isArabic ? 'المزايا الرئيسية لمكتب علوم المعاجم للترجمة' : 'Why Choose Lexicology Translation Office?' }}
            </p>
        </div>

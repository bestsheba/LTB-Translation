    ...
    $services = $isArabic
        ? [
            ...
            [
                ...
                'desc' => 'المواد الهندسية والعلمية والتقنية.',
                'icon' => 'fa-solid fa-gears',
            ],
            [
                'title' => 'الترجمة الطبية:',
                'desc' => 'التقارير الطبية والمستندات الصحية باستخدام مصطلحات طبية دقيقة.',
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-12">
            ...
            <p class="text-xl md:text-2xl text-[#D60F12] mb-3">
                {{ $isArabic ? 'خدماتنا المتخصصة في الترجمة' : 'Specialized Translation Services' }}
            </p>
        </div>

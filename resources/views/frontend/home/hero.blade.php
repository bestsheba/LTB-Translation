<section class="relative bg-white mt-10 lg:mt-0 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('translation-office.webp') }}" alt="Translation Office Background"
            class="w-full h-full object-cover">
        <!-- Gradient Overlay for better text readability -->
        <div class="absolute inset-0 bg-gradient-to-r from-[#00015B]/95 via-[#00015B]/85 to-[#00015B]/70"></div>
    ...
    <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 lg:py-32">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <!-- Subtitle -->
            <p class="mt-6 text-[#FFD700] text-lg sm:text-xl md:text-2xl font-semibold animate-fade-in-delay-1">
            ...
            <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-3">
                <a href="{{ route('quote.index') }}"
                    class="group px-8 py-4 text-[#00015B] bg-white hover:bg-[#FFD700] rounded-lg text-base sm:text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">

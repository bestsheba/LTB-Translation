    ...
    <div class="bg-white">
        ...
        <div class="relative py-16 bg-indigo-600">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p class="mt-6 max-w-3xl mx-auto text-xl text-indigo-100 text-center">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                @foreach($services as $service)
                    <div class="relative bg-white p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div class="mt-16 bg-indigo-50 rounded-lg px-6 py-12 text-center">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="{{ url('/quote') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                        Request a Quote
                    </a>
                    <a href="{{ url('/contact') }}" class="inline-flex items-center px-6 py-3 border border-indigo-600 text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50">
                        Contact Us
                    </a>
                </div>
            </div>

...
@section('title', __('messages.quote_page_title'))
@section('content')
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 sm:p-8">
            @if (session('success'))
                <div class="mb-8 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded relative"
                    role="alert">
                    <p class="font-medium">{{ __('messages.success_message') }}</p>
                </div>
            @endif
            ...
            <form action="{{ route('quote.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="space-y-2">
                    <label for="full_name"
                        class="block text-sm font-medium text-gray-900">{{ __('messages.full_name') }}</label>
                ...
                <div class="space-y-2">
                    <label for="email"
                        class="block text-sm font-medium text-gray-900">{{ __('messages.email_address') }}</label>
                ...
                <div class="space-y-2">
                    <label for="phone"
                        class="block text-sm font-medium text-gray-900">{{ __('messages.phone_number') }}</label>
                ...
                <div class="space-y-2">
                    <label for="message"
                        class="block text-sm font-medium text-gray-900">{{ __('messages.message') }}</label>
            ...
            <div class="mt-8 text-center text-sm text-gray-500">
                {{ __('messages.well_respond_promptly') }}
            </div>
        </div>
    </div>
@endsection
